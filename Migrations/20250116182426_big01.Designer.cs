...
namespace Paslauga.Migrations
{
    ...
    [Migration("20250116182426_big01")]
    partial class big01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Paslauga.Entities.HardwareSuppliers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Paslauga.Entities.Provider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Paslauga.Entities.ProviderResources", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Paslauga.Entities.CPU", b =>
                {
                    b.HasOne("Paslauga.Entities.HardwareSuppliers", "HardwareSupplier")
                        .WithMany()
                        .HasForeignKey("SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HardwareSupplier");
                });

            modelBuilder.Entity("Paslauga.Entities.ProviderResources", b =>
                {
                    b.HasOne("Paslauga.Entities.CPU", "CPU")
                        .WithMany()
                        .HasForeignKey("HardwareId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Paslauga.Entities.RAM", "RAM")
                        .WithMany()
                        .HasForeignKey("HardwareId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Paslauga.Entities.Storage", "Storage")
                        .WithMany()
                        .HasForeignKey("HardwareId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Paslauga.Entities.Provider", "Provider")
                        .WithMany()
